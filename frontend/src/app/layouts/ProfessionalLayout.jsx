...
export default function ProfessionalLayout() {
  ...
  const sidebarSections = [
    {
      title: "Actividad",
      items: [
        { to: ROUTES.PROFESSIONAL_AGENDA, icon: CalendarIcon, label: "Mi Agenda" },
        { to: ROUTES.PROFESSIONAL_NOTIFICATIONS, icon: BellIcon, label: "Notificaciones" },
      ],
    },
    {
      title: "Descubrir",
      items: [
        { to: ROUTES.PROFESSIONAL_MARKETPLACE, icon: BuildingStorefrontIcon, label: "Marketplace" },
      ],
    },
    {
      title: "Mi Cuenta",
      items: [
        { to: ROUTES.PROFESSIONAL_PROFILE, icon: UserIcon, label: "Mi perfil" },
        { to: ROUTES.PROFESSIONAL_SETTINGS, icon: Cog6ToothIcon, label: "Configuración" },
      ],
    },
    {
      title: "Soporte",
      items: [
        { to: ROUTES.PROFESSIONAL_HELP, icon: QuestionMarkCircleIcon, label: "Ayuda" },
      ],
    },
  ];
  ...
  return (
    <div className="flex flex-col h-screen bg-[#202020] text-[#FFFFFF] font-sans overflow-hidden">
      {/* ── Header 100% Width ────────────────────────────────────── */}
      <Header
        logoLink={ROUTES.PROFESSIONAL_AGENDA}
        logoText="Argendar"
