 ...
 * Incluye Header superior y Sidebar con las secciones:
 * - ACTIVIDAD: Dashboard, Usuarios, Transacciones, Moderación, Bandeja de consultas
...
export default function AdminLayout() {
  ...
  // Secciones del menú lateral para Administrador según captura de diseño
