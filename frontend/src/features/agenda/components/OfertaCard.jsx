        ...
        <div className="pt-1 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex w-full items-center justify-end gap-3 sm:w-auto">
            <button 
              ...
              className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 rounded-[6px] px-4 py-2.5 text-xs font-medium bg-transparent text-white border border-[#323232] hover:border-[#A8A8AA] active:scale-[0.98] transition-all duration-200 focus:outline-none"
            >
            ...
            <button 
              ...
              className="flex-1 sm:flex-none inline-flex items-center justify-center gap-2 rounded-[6px] px-4 py-2.5 text-xs font-medium text-white bg-[#F78736] hover:bg-[#e06d00] active:scale-[0.98] transition-all duration-200 focus:outline-none"
            >
              Ver mi oferta
            </button>
          </div>
