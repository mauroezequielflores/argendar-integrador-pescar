...
export default function PublicProfileTab({ profile }) {
  ...
  return (
    <div className="mt space-y-6">
      {/* ── Fila: Resumen de Calificaciones & Opiniones recientes ── */}
      <div className="grid grid-cols-1 md:grid-cols-[300px_1fr] gap-6">
        ...
        <div className="bg-[#292929] rounded-[6px] p-6 border border-[#3a3a3a] flex flex-col items-center">
          ...
          <p className="text-xs text-[#A8A8AA] mb-8">
            Basado en {profile.reviewsCount || 0} opiniones
          </p>
        ...
        <div className="bg-[#292929] rounded-[6px] border border-[#3a3a3a] p-6 flex flex-col">
          ...
          <div className="flex-1 flex flex-col items-center justify-center text-center">
            ...
            <h3 className="text-[#FFFFFF] font-bold text-lg mb-2">
              Aún no enviaste ninguna opinión
            </h3>
            ...
            <button
              ...
              className="bg-[#F78736] hover:bg-[#e06d00] text-[#FFFFFF] font-medium text-sm px-6 py-2.5 rounded-[6px] transition-colors cursor-pointer"
            >
              Solicitar servicio
            </button>
          </div>
