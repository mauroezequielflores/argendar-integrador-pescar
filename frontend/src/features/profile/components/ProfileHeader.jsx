  ...
  return (
    <div className="flex flex-col w-full">
      ...
      <div className="relative w-full h-20 sm:h-30 md:h-40 rounded-[12px] overflow-hidden bg-[#292929] border border-[#323232]">
        <img
          src={profile.coverPhoto || headerDefaultPhoto}
      ...
      <div className="-mt-14 sm:-mt-16 ml-4 sm:ml-6 relative z-10 w-fit">
        <div className="relative h-24 w-24 sm:h-28 sm:w-28 rounded-full border-4 border-[#202020] bg-[#292929] overflow-hidden shadow-lg">
          <img
            src={profile.photo || profileDefaultPhoto}
            alt="Foto de perfil"
            className="w-full h-full object-cover"
          />
        </div>
